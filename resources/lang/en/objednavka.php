...
return array(
    ...
    */
    ...
    'orders_none' => 'Nemáte v košíku žiadne diela',
    'orders_remove' => 'odstrániť',
    'orders_warning' => 'Toto dielo momentálne nemáme zdigitalizované v dostatočnej kvalite, vybavenie objednávky preto môže trvať dlhšie ako zvyčajne.',

    'orders_form_title' => 'Diela objednávky',
    'orders_form_name' => 'Meno',
    'orders_form_address' => 'Adresa',
    'orders_form_email' => 'E-mail',
    'orders_form_phone' => 'Telefón',
    'orders_form_format' => 'Formát',
    'orders_form_format_for-print' => 'tlačená reprodukcia :',
    'orders_form_format_a4' => 'do formátu A4 (24 €/ks)',
    'orders_form_format_a3' => 'do formátu A3+ (35 €/ks)',
    'orders_form_format_for-download' => 'na stiahnutie :',
    'orders_form_format_digital' => 'digitálna reprodukcia',
    'orders_form_purpose-alert' => 'Autorský zákon nám neumožňuje poskytovať digitálne reprodukcie <abbr title="neprešlo 70 rokov od smrti autora" data-toggle="tooltip">autorsky chránených diel</abbr> na všeobecné súkromné účely (napr. ako dekoráciu). Na základe Vami uvedených informácií vytvorí SNG písomný súhlas s využitím digitálnej reprodukcie iba na predmetný účel &ndash; je to legislatívna ochrana tak pre Vás ako aj pre nás.<br>
    ...
    'orders_form_purpose-label' => 'Účel',
    'orders_form_purpose-info' => 'Účel - podrobnejšie informácie',
    
    'orders_form_delivery-point' => 'Miesto osobného odberu',
    'orders_form_delivery-point_exlibris' => 'Kníhkupectvo Ex Libris v SNG',
    'orders_form_delivery-point_zvolen' => 'Zvolenský zámok',
    'orders_form_note' => 'Poznámka',
    'orders_form_order' => 'Objednať',
);