        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="{!! route('collection.create') !!}" class="btn btn-primary btn-outline"><i
                        ...
                        <tbody>
                            @foreach ($collections as $i)
                                <tr>
                                    ...
                                    <td>
                                        {!! link_to_action('App\Http\Controllers\CollectionController@show', 'Detail', [$i->id], ['class' => 'btn btn-primary btn-detail btn-xs btn-outline']) !!}
                                        {!! link_to_action('App\Http\Controllers\CollectionController@edit', 'Upraviť', [$i->id], ['class' => 'btn btn-primary btn-xs btn-outline']) !!}
                                        {!! link_to_action('App\Http\Controllers\ItemController@index', 'Diela', ['collection_id' => $i->id], ['class' => 'btn btn-primary btn-xs btn-outline']) !!}
                                        <a href="{!! $i->getUrl() !!}"
