    ...
    <div class="container">
        ...
        <div class="row content-section">
            <div class="col-sm-12 text-center">
                <a href="{!! route('frontend.catalog.index', ['is_for_reproduction' => 1]) !!}" class="btn btn-default btn-outline sans" >{{ trans('reprodukcie.more-items_button') }} <strong>{{ $total }}</strong>  <i class="fa fa-chevron-right "></i></a>
            </div>
        </div>
    </div>
</section>
