...
<section class="filters">
    <div class="container content-section"><div class="expandable">
            ...
            <div class="row">
                ...
                <div  class="col-md-4 col-xs-6 bottom-space">
                        {!! Form::select('exhibition', array('' => '') + $exhibitions, @$input['exhibition'], array('class'=> 'custom-select form-control', 'data-placeholder' => trans('katalog.filters_exhibition'))) !!}
                </div>
                	...
                	@foreach ($items as $i=>$item)
    	                <div class="col-md-3 col-sm-4 col-xs-6 item">
                            ...
                            <div class="item-title">
                                @if ($item->has_iip)
                                    <div class="pull-right"><a href="{{ URL::to('dilo/' . $item->id . '/zoom') }}" data-toggle="tooltip" data-placement="left" title="{{ utrans('general.item_zoom') }}"><i class="fa fa-search-plus"></i></a></div>
                                @endif
