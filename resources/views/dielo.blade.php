        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <a href="{!! URL::to('dilo/' . $item->id . '/objednat')  !!}" class="btn btn-default btn-outline  sans"><i class="fa fa-shopping-cart"></i> {{ trans('dielo.item_order') }} </a>
                            @endif
                            @if ($item->isFree() && $item->hasZoomableImages())
                            <a href="{!! URL::to('dilo/' . $item->id . '/stiahnut')  !!}" class="btn btn-default btn-outline  sans" id="download"><i class="fa fa-download"></i> {{ trans('dielo.item_download') }} </a>
                            @endif
                        </div>
                ...
                <div class="col-md-4 text-left">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="expandable">{!! implode('<br> ', $item->makeArray($item->inscription));!!}</div>
                                </td>
                            </tr>
                            @endif
                            ...
                            <tr>
                                <td class="atribut">{{ trans('dielo.item_attr_exhibition') }}:</td>
                    ...
                    <div>
                        @if (!empty($item->related_work))
                        <?php $related_items = App\Item::where('related_work', '=', $item->related_work)->where('author', '=', $item->author)->orderBy('related_work_order')->limit(20)->get() ?>
