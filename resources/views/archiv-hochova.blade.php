    ...
    @section('content')
        ...
        <section class="info content-section">
            <div class="info-body">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 pl-50 lead attributes">
                            <p>
                        ...
                        <div class="col-md-6 attributes">
                            ...
                            <p>
                                Jiří Pátek, Moravská galerie v Brně<br />
