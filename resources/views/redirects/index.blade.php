        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="{!! route('redirects.create') !!}" class="btn btn-primary btn-outline"><i
                        ...
                        <tbody>
                            @foreach ($redirects as $redirect)
                                <tr>
                                    ...
                                    <td>
                                        {!! link_to_action('App\Http\Controllers\RedirectController@edit', 'Upraviť', [$redirect->id], ['class' => 'btn btn-primary btn-xs btn-outline']) !!}
                                        <x-admin.link-with-confirmation
                                            action="{{ route('redirects.destroy', $i->id) }}"
