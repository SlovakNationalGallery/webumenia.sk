...
<section>
    <div class="container text-center share-icons">
        ...
        <a href='https://twitter.com/intent/tweet?text={!! $collection->name !!}&url={!! $collection->getUrl() !!}'
        target='_blank' class="no-border" data-toggle="tooltip" title='{{ trans('general.share_twitter') }}'>
            <i class='fa fa-twitter fa-lg'></i>
        </a>
    
        <a href='//www.pinterest.com/pin/create/button/?url={!! $collection->getUrl() !!}' class='pin-it-button no-border'
        count-layout='none' target='_blank' data-toggle="tooltip" title="{{ trans('general.share_pinterest') }}">
            <i class='fa fa-pinterest fa-lg'></i>
        </a>
        <a href='mailto:?subject={!! $collection->name !!}, {{trans('informacie.info_gallery_SNG')}}&body={!!$collection->getUrl()!!}'
        style="font-size:0.9em" target='_blank' class="no-border" data-toggle="tooltip"
        title="{{ trans('general.share_mail') }}">
            <i class='fa fa-envelope fa-lg'></i>
        </a>
        <a onclick='copyLinkToClipboard("{!!$collection->getUrl()!!}")' style='cursor:pointer' data-toggle="tooltip" class="no-border"
