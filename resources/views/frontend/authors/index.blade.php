    ...
    <section class="authors">
        <div class="container">
            <div class="row content-section">
                <div class="col-xs-6">
                    @if (!empty($search))
                        <h4 class="inline">{{ utrans('authority.authors_found') }} &bdquo;{!! $search !!}&ldquo; (<span data-searchd-total-hits>{!! $paginator->total() !!}</span>) </h4>
                    @else
                        <h4 class="inline">{!! $paginator->total() !!} {{ trans('authority.authors_counted') }}</h4>
                    @endif
