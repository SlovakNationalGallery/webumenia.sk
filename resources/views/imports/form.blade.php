...
<div class="col-md-6">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            {!! Form::text('name', Request::old('name'), array('class' => 'form-control', 'placeholder' => '', 'disabled' => $disabled_metadata_fields)) !!}
            </div>

            <div class="form-group">
            {!! Form::label('class_name', 'Trieda') !!}
            {!! Form::text('class_name', Request::old('class_name'), array('class' => 'form-control', 'placeholder' => '', 'disabled' => $disabled_metadata_fields)) !!}
            </div>

            <div class="form-group">
            {!! Form::label('dir_path', 'Priečinok') !!}
            <div class="input-group">
                <div class="input-group-addon">{{ $import->disk ?? 'import' }}</div>
            ...
            {!! Form::text('iip_dir_path', Request::old('iip_dir_path'), array('class' => 'form-control', 'placeholder' => '/mnt/DG_PUBLIC_IS/MGHQ', 'disabled' => $disabled_metadata_fields)) !!}
            </div>

            <div class="form-group">
            {!! Form::label('user_id', 'Používateľ') !!}
            {!! Form::select('user_id', App\User::pluck('name', 'id')->prepend(null, null), Request::old('user_id', isset($import) ? $import->user_id : null), array('class' => 'form-control', 'disabled' => $disabled_metadata_fields)) !!}
            </div>
        </div>
    </div>
</div>
