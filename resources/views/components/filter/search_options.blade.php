    ...
    <div class="tw-flex tw-w-full tw-flex-1 tw-flex-col">
        <div class="tw-mx-4 tw-mb-6 tw-flex tw-border tw-border-gray-800 md:tw-mx-0">
            <input
                ...
                type="text" v-on:input="sc.onSearchInput" :value="sc.search"
        ...
        <div
            ...
            <label v-if="sc.options.length > 0" v-for="option in sc.options" :for="option . id"
                :class="['tw-flex md:tw-px-2 tw-px-4 tw-my-0.5 tw-py-1 hover:tw-bg-gray-200', { 'tw-bg-gray-200': option.checked }]">
                <input
