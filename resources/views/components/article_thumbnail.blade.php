...
<div class="tailwind-rules">
    <div
        ...
        <div
            ...
            <div
                class="tw-mb-9 tw-min-h-0 tw-flex-1 tw-overflow-hidden tw-bg-gradient-to-b tw-from-gray-800 tw-via-gray-800 tw-to-white tw-bg-clip-text tw-font-serif tw-text-xl tw-text-transparent">
