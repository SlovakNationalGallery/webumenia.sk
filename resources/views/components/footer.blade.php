<div class="footer">
  <div class="container">
    <div class="row">
      <div class="col-sm-6 text-center sm:tw-text-left top-space bottom-space">
        ...
        <a href="mailto:lab@sng.sk" target="_blank" data-toggle="tooltip" title="email"><i class="fa fa-envelope-o fa-lg"></i></a>
      </div>
      <div class="col-sm-6 text-center sm:tw-text-right top-space bottom-space">
