...
<head>
    ...
    <link rel="alternate" hreflang="{{ LaravelLocalization::getDefaultLocale() }}"
        href="{{ LaravelLocalization::getNonLocalizedURL() }}">
...
<body id="page-top">
    ...
    <script>
        (function(d, s, id) {
            ...
            js.id = id;
            js.src =
                "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=1429726730641216&version=v2.0";
    ...
    @if (session('scena_ai_key') ?? config('services.scena_ai.key'))
        <scena-ai-popup key-id="{{ session('scena_ai_key') ?? config('services.scena_ai.key') }}"
            id="scena-ai"></scena-ai-popup>
    ...
    <div id="top">
        <a href="#page-top" title="{{ trans('master.to_top') }}" class="btn btn-default"
