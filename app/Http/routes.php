...
function() 
{
    ...
    Route::get('dielo/{id}/objednat', function ($id) {
        ...
        Session::flash( 'message', trans('objednavka.message_add_order', ['artwork_description' => '<b>'.implode(', ', $item->authors)." – $item->title</b> (".$item->getDatingFormated().')']) );
    ...
    Route::get('dielo/{id}/odstranit', function ($id) {
        ...
        Session::flash('message', trans('objednavka.message_remove_order', ['artwork_description' => '<b>'.implode(', ', $item->authors)." – $item->title</b> (".$item->getDatingFormated().')']) );
