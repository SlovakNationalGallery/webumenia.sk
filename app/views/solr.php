            ...
            <section id="painting" class="section-container">
                <div class="container">
                    ...
                    <ul class="grid cs-style-3">
                        ...
                        <a href="images/diela2/<?php echo getImagePath($item->id); ?>" data-source="http://webumenia.sk/web/guest/detail/-/detail/id/SVK:SNG.O_754/" title="<?php echo $item->firstAuthor .' : '. $item->ti[0] ?>">
