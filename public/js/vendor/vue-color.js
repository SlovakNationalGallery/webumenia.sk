...
var _Hue = __webpack_require__(14);

var _Hue2 = _interopRequireDefault(_Hue);

var _Lightness = __webpack_require__(55);
...
var _tinycolor = __webpack_require__(51);
...
function _colorChange(data, oldHue, oldLightness) {
    ...
    if (hsl.s === 0) {
        ...
        hsv.s = hsl.s = data.s || data.hsl && data.hsl.s || 100;
    }
...
exports.default = {
    ...
    methods: {
        hueChange: function hueChange(hue) {
            this.oldHue = hue;
            var data = { hsl: (0, _extends3.default)({}, this.val.hsl, { h: hue }) };
            this.colors = _colorChange(data);
        },
        lightnessChange: function lightnessChange(lightness) {
            this.oldLightness = lightness;
            var data = { hsl: (0, _extends3.default)({}, this.val.hsl, { l: lightness }) };
            this.colors = _colorChange(data);
        }
    }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Hue_vue__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7b9aea78_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Hue_vue__ = __webpack_require__(54);
var disposed = false
...
exports.default = {
  ...
  computed: {
    ...
    pointerLeft: function pointerLeft() {
      if (!this.hue && this.pullDirection === "right") return "100%";
      return this.hue * 100 / 360 + "%";
    }
  },
  methods: {
...
exports.default = {
  ...
  computed: {
    backgroundColor: function backgroundColor() {
      return "hsl(" + this.hue + ", 100%," + this.lightness * 100 + "%)";
    },
    pointerLeft: function pointerLeft() {
      if (this.lightness === 0 && this.pullDirection === "right") return "100%";
      return this.lightness * 100 + "%";
    }
  },
  methods: {
    handleChange: function handleChange(e, skip) {
    ...
    emitValue: function emitValue(eventName) {
      this.$emit(eventName, this.lightness);
    }
  }
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Slider_vue__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2dedc691_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Slider_vue__ = __webpack_require__(57);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var update = __webpack_require__(6)("7982aa43", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("7c5f1a1c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "vc vc-hue", class: { active: _vm.showButton } },
    [
      _c(
        "div",
        {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Lightness_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Lightness_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Lightness_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Lightness_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Lightness_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1c0540b9_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Lightness_vue__ = __webpack_require__(56);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1c0540b9_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Lightness_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "vc-slider-warp" },
        [
          _c("hue", {
            attrs: {
              hue: _vm.colors.hsl.h,
              startEmpty: !_vm.value || !_vm.value.a
            },
      ...
      _c(
        "div",
        { staticClass: "vc-slider-warp vc-light" },
        [
          _c(
            "transition",
            { attrs: { name: "fade" } },
            [
              _c("lightness", {
                ...
                attrs: { hue: _vm.colors.hsl.h, lightness: _vm.colors.hsl.l },
                on: {
                  change: _vm.lightnessChange,
                  changemouseup: _vm.changeMouseUp
                }
              })
            ],
            1
