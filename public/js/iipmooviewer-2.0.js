...
var IIPMooViewer = new Class({
  ...
  createWindows: function(){
	...
	click: function(){ this.fade('out'); }
      ...
      'html': '<div><div><h2>IIPMooViewer</h2><ul><li>'+IIPMooViewer.lang.navigate+'</li><li>'+IIPMooViewer.lang.zoomIn+'</li><li>'+IIPMooViewer.lang.zoomOut+'</li><li>'+IIPMooViewer.lang.rotate+'</li><li>'+IIPMooViewer.lang.fullscreen+'<li>'+IIPMooViewer.lang.annotations+'</li><li>'+IIPMooViewer.lang.navigation+'</li></ul></div></div>'
    }).inject( this.container );
